// approval-service Container App. Service-owned; references platform resources with `existing`.
targetScope = 'resourceGroup'

@allowed(['dev', 'test', 'prod'])
param environment string
param location string = resourceGroup().location
param serviceName string = 'approval-service'
...
resource app 'Microsoft.App/containerApps@2025-01-01' = {
  name: appName
  location: location
  tags: union(tags, { 'meridian:environment': environment, 'meridian:service': serviceName, 'meridian:owner': 'approvals-team' })
  identity: {
    type: 'UserAssigned'
      ...
      containers: [
        {
          ...
          env: [
            ...
            { name: 'Storage__Provider', value: 'Cosmos' }
